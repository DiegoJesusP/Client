        ...
        <Navbar fluid rounded style={{backgroundColor:"paleturquoise"}}>
          ...
          <div className="flex md:order-2">
            <Dropdown
              ...
              inline
              label={
                <Avatar alt="User settings" img="https://petencito.usac.edu.gt/wp-content/uploads/2018/08/21.jpg" rounded />
              }
            >
              <Dropdown.Header>
                <span className="block text-sm">LimberTie</span>
                <span className="block truncate text-sm font-medium">LimberTie@gmail.com</span>
              </Dropdown.Header>
